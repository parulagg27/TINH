...
export class SearchComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.add_map_point(this.latitude+0.5, this.longitude+0.5, "https://upload.wikimedia.org/wikipedia/commons/e/ec/RedDot.svg");
    ...
    this.add_map_point(this.latitude+0.512, this.longitude+0.53, "https://upload.wikimedia.org/wikipedia/commons/e/ec/RedDot.svg");
    ...
    this.add_map_point(this.latitude+0.15, this.longitude+0.53, "https://upload.wikimedia.org/wikipedia/commons/e/ec/RedDot.svg");
